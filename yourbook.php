...
<head>
	...
	<section>
			<article class="classes-gallery">
				<div class="container">
					<h2 style="color:black;"><b>LET'S SET FIT</b></h2>
...
<thead style="background-color: #fc3031; color: white; font-size: 23px;"><tr><th width="200">Course Name</th>
<th width="200">Trainer Name</th>
<th width="200">Start Date</th>
<th width="200">Periods</th>
...
<tbody>
					    <?php
					    	$uid=$_SESSION['id'];
                                            $query=$admin->ret("select * from `booking` inner join `ccourse` on booking.courseid=ccourse.cc_id where usid='$uid'")or die("wrong"); 	
 ...
 while($row=$query->fetch(PDO::FETCH_ASSOC))
	...
	<tr>
		...
		<td style="color: black;"><?php echo $row['course'];?></td>
		<td style="color: black;"><?php echo $row['guideid'];?></td>
