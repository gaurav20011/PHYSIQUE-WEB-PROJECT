...
<?php 
$gname=$_SESSION['name'];
$u=$admin->ret("select * from guide where `email`='$gname'");
$rt=$u->fetch(PDO::FETCH_ASSOC);
 $name=$rt['gname'];
                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <hr>
                              ...
                              <tbody>
                                <?php
                               $table='user';
                               $stmt=$admin->ret("SELECT * FROM `user` inner join `booking` on `user`.`uid`=`booking`.`usid` where guideid='$name'");
