...
<section id="main-content">
          <section class="wrapper">
            <h3><b><i class="fa fa-angle-right"></i> VIEW COURSE DETAILS</b></h3>
  <div class="row mt">
                  <div class="col-md-12">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <hr>
                              ...
                              <tr>
                                 ...
                                 <td><a href="updatecourseform.php?id=<?php echo $row['cid'];?>" onclick="
                                   return confirm('Are you sure you want to update?')" class="btn btn-success">Update</a>

                                  </td>
          <td><a href="Controller/deletecourse.php?id=<?php echo $row['cid'];?>" onclick="
