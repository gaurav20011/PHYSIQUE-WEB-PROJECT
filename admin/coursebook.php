...
<section id="main-content">
          <section class="wrapper">
            <h3><b><i class="fa fa-angle-right"></i> VIEW PAYMENT DETAILS</b></h3>
  <div class="row mt">
                  <div class="col-md-12">
...
<th width="200">Delivery Date</th>
                              ...
                              <tbody>
                                <?php
                $uid=$_SESSION['id'];
                                            $query=$admin->ret("select * from `purchase_list` inner join `purchase` on purchase_list.O_ID=purchase.id inner join equipment on purchase_list.P_ID=equipment.eid ")or die("wrong");  
 ...
 while($row=$query->fetch(PDO::FETCH_ASSOC))
    ...
    <td style="color: black;"><img src="Controller/<?php echo $row['image'];?>" style="height: 50px;width:50;"></td>
