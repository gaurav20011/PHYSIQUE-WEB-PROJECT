            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="Controller/addcoursefile.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select class="form-control" name="guname" required>
                                    <option value="">Select guide</option>
                                    <?php 
                                    $stmt = $admin->ret("SELECT * FROM `guide`");
                                    while($row= $stmt->fetch(PDO::FETCH_ASSOC))
                                    {
                                      ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="number" class="form-control" name="duration" placeholder="hours" required>
                              </div>
                          </div>
