            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <?php 
                    $id=$_GET['id'];
                    $stmt=$admin->ret("SELECT * FROM `course` where cid=".$id);
                    $row= $stmt->fetch(PDO::FETCH_ASSOC);
                    ?>

                      <form class="form-horizontal style-form" action="Controller/updatecourse.php" method="post" enctype="multipart/form-data">
                        
                        <input value="<?php echo $row['cid'];?>" type="hidden" name="cid">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Guide Name</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="guname" value="<?php echo $row['guname'];?>" required >
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <img src="Controller/<?php echo $row['image'];?>" style="width: 50px;height: 50px;" >
                                <input type="file" name="image" value="<?php echo $row['image'];?>"  >
                                <input type="hidden" name="pim" value="<?php echo $row['image'];?>"  >
                              </div>
                          </div>
                           
                          <input type="submit" name="update" class="btn btn-success" value="Update Course" >
                      </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
