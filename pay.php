...
<body style="background-color:#fc3031;;">
 <div class="payment-title">
    ...
    <div class="form-container">
    	<form action="Controller/paymentfile.php" method="post">
        <div class="field-container">
            <label for="name" style="color: black;"><b>Name</b></label>
            <input id="name" maxlength="20" type="text" required>
            <input type="hidden" name="bid" value="<?php echo $bid;?>">
            <input type="hidden" name="ccost" value="<?php echo $cost;?>">
            <input type="hidden" name="tcost" value="<?php echo $tcost;?>">
            <input type="hidden" name="uid" value="<?php echo $uid;?>">
        </div>
        <div class="field-container">
            <label for="cardnumber"  style="color: black;"><b>Card Number</b></label><span id="generatecard">generate random</span>
        ...
        <div class="field-container">
            <label for="expirationdate"  style="color: black;"><b>Expiration (mm/yy)</b></label>
            <input id="expirationdate" type="text"  inputmode="numeric" required>
        </div>
        <div class="field-container">
            <label for="securitycode" style="color: black;"><b>Security Code</b></label>
            <input id="securitycode" type="text" pattern="[0-9]*" inputmode="numeric" required>
        </div>
        <div><button style="background-color:black;color: white;width: 52px;height: 35px;align-content: center;" type="submit">PAY</button></div>
        </form>
    </div>
